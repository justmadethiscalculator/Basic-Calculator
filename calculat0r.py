...
e.grid(row=0,column=0,columnspan=3,padx=10,pady=10) #columnspan=S chiếm ô; S 1 cell = ô có Smax

def button_click(number):
	current=e.get()#lấy số trong text box
	e.delete(0, END)#xóa trong text box
	e.insert(0, str(current)+str(number))#cho số vào text box
